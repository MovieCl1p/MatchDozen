...
namespace strange.extensions.injector.impl
{
	public class Injector : IInjector
	{
		...
		//Inject the value into the target at the specified injection PointTo
		private void injectValueIntoPoint(object value, object target, PropertyInfo point)
		{
			...
			failIf(point == null, "Attempt to inject into a null PointTo", InjectionExceptionType.NULL_INJECTION_POINT);
