...
public class tk2dUIScrollableArea : MonoBehaviour
{
    ...
    public event System.Action<tk2dUIScrollableArea> OnScrollFinished;
    ...
    public float SwipeCurrentVelocit
    {
        set
        {
            swipeCurrVelocity = value;
        }

        get
        {
            return swipeCurrVelocity;
        }
    }

    public void SetContentPosition(float offset)
    {
    ...
    private void SetContentPosition()
    {
        ...
        /*if (pos > contentLength - visibleAreaLength)
        {
            pos = contentLength - visibleAreaLength;
        }*/
